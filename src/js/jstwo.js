const LiquidButton = class LiquidButton {
  constructor(optionsParam) {
    ...
    this.text = options.text || "Ấn vào đây nha!";
    ...
    // Đảm bảo rằng canvas có thể nhận sự kiện click
    this.canvas.style.cursor = "pointer"; // Thêm hiệu ứng con trỏ

    // Thêm sự kiện click để chuyển hướng trang
    const redirectUrl = "../../public/phaohoa.html"; // URL cần chuyển hướng
